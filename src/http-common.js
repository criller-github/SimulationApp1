...
export default axios.create({ //Opretter en ny Axios-instans 
  baseURL: "http://localhost:8080/api", //Indstiller den grundlæggende URL for API'en: http://localhost:8080/api. Hver HTTP-anmodning (GET, POST, PUT osv.) sendt fra denne instans tilføjer automatisk denne base-URL
